...
public class AuthenticatedUserInfoPanel extends Panel {
    ...
    public AuthenticatedUserInfoPanel(String wicketId) {
        super(wicketId);
    }
    ...
    protected void onInitialize() {
        ...
        add(initUserLabel("user"));
        add(initLogoutLink("logout"));
    }

    private Label initUserLabel(String wicketId) {
